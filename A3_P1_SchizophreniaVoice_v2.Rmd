...
p_load(dplyr, lmerTest, ggplot2, stringr, plyr, caret, modelr, ModelMetrics, tidyverse, MASS, simr, MuMIn, cvTools, hydroGOF, lsr, pastecs, crqa)
...
#try() --> selvom den ikke for en værdig så looper den videre/crasher ikke
