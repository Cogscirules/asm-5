...
wd2 = setwd("C:/Users/Bruger/Desktop/Programming/Semester 3/asm. 5/Pitch")

pitch_files=list.files(wd2, full.names = T)
...
for (i in pitch_files){
  x = read_csv(i)
  x = x$f0
  result = crqa(x, x, delay = median(df1$delay), embed = median(df1$embed), radius = median(df1$radius))
